<template>
	<view class="write">
		...
		<view class="write-top">
			<view class="write-pic" @click="uploadArticlePic"><image :src="articlePic" mode="aspectFill"></image></view>
			<textarea class='write-title-textarea' auto-height='true' :value="articleTitle" @input='inputChange($event)' placeholder="请输入标题"></textarea>
		</view>
		...
		<view class="content">
			...
			<view class="ad-content">
				<view class="ad-line"></view><view class="ad-text">广告</view><view class="ad-line"></view>
			</view>
			<view v-html="adContent"></view>
		</view>
		<!-- 内容编辑工具 -->
			...
			<view class="model">
				...
				<view class="model-content">
					<textarea v-model="modalValue" :style="{
					 ...
					 :placeholder="modalPlaceHolder" placeholder-class="model-placeholder"></textarea>
				</view>
	...
	export default {
		data() {
			return {
				...
				fontSize: '14px',
				textAlign: 'left',
				textAlignList: [{val:'left',text:'左对齐'}, {val:'center',text:'居中对齐'}, {val:'right',text:'右对齐'}],
				fontSizeList: [{val:'2.4vw',text:'12px'},{val:'2.8vw',text:'14px'},{val:'3.6vw',text:'18px'},{val:'4vw',text:'20px'},{val:'5vw',text:'24px'},{val:'6vw',text:'28px'}],
		...
		methods: {
			...
			goSave() {
				...
				let content = this.content.map(res => {
					if(res!=='<div class="hs-text" style="color:#000;font-weight:normal;text-align:left;font-size:14px;">点击开始编辑文章内容</div>'){
